(function (global, factory) {
    ...
    */
    ...
    class VibCrystal {
        ...
        */
        ...
        capturestart(format) {
            ...
            this.capturer = new CCapture( options ), this.capturer.start();
        }
        ...
        constructor(container) {
            ...
            this.HighchartsOptions = {
                chart: { type: 'line',
                    zoomType: 'xy' },
                credits: {
                    text: 'Using the phonon visualiser' ,
    ...
    class PhononWebpage {
        ...
        loadLocalJSON(data) {
            /*
            read structure from a local json
            */

            this.phonon = new PhononJson();
            this.phonon.getFromInternalJson(data, this.loadCallback.bind(this) );
